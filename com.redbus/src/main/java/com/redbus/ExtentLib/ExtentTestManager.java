...
import com.redbus.BaseLib.BaseClass;
...
public class ExtentTestManager implements ITestListener {
	...
	public void onStart(ITestContext context) {
		...
		sExcelDate = sDate;
		sStartTime = sDate;
		String testOutputDir = BaseClass.userDirectory + "/test-output";
		String htmlDir = BaseClass.userDirectory + "/reports" + "/Run-" + sDate + "/extent/";
		String excelDir = BaseClass.userDirectory + "/reports" + "/Run-" + sDate + "/excel/";
		sExcelPath = excelDir;
		screenShotPath = BaseClass.userDirectory+ "/reports" + "/Run-" + sDate + "/screenshots";
